...
export default class QuestaoModel {
    ...
    embaralharRespostas(): QuestaoModel{ 
        ...
        return new QuestaoModel(this.#id, this.#enunciado, respostasEmbaralhadas) /* retornamos uma nova instância para não mexer na atual */
    }


    // método usado para transformar o JSON recebido da API em uma instância dos nossos models
